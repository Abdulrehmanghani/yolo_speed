...
from ultralytics_1.utils import ASSETS_URL, DEFAULT_CFG_DICT, DEFAULT_SOL_DICT, LOGGER
...
class BaseSolution:
    ...
    Attributes:
        ...
        model (ultralytics_1.YOLO): Loaded YOLO model instance.
    ...
    def extract_tracks(self, im0):
        ...
        """
        self.tracks = self.model.track(source=im0, persist=True, classes=[0], **self.track_add_args)
