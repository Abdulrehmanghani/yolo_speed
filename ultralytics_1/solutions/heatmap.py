...
from ultralytics_1.solutions.object_counter import ObjectCounter
...
class Heatmap(ObjectCounter):
    ...
    Examples:
        >>> from ultralytics_1.solutions import Heatmap
    ...
    def generate_heatmap(self, im0):
        """
        Generate heatmap for each frame using ultralytics_1.
