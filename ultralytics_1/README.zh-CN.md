...
[Ultralytics](https://www.ultralytics_1.com/) [YOLO11](https://github.com/ultralytics/ultralytics) 是一个尖端的、最先进（SOTA）的模型，基于之前 YOLO 版本的成功，并引入了新功能和改进以进一步提升性能和灵活性。YOLO11 被设计得快速、准确且易于使用，是进行广泛对象检测和跟踪、实例分割、图像分类和姿态估计任务的理想选择。

我们希望这里的资源能帮助你充分利用 YOLO。请浏览 Ultralytics <a href="https://docs.ultralytics_1.com/">文档</a> 以获取详细信息，在 <a href="https://github.com/ultralytics/ultralytics/issues/new/choose">GitHub</a> 上提出问题或讨论，成为 Ultralytics <a href="https://discord.com/invite/ultralytics">Discord</a>、<a href="https://reddit.com/r/ultralytics">Reddit</a> 和 <a href="https://community.ultralytics_1.com/">论坛</a> 的成员！

想申请企业许可证，请完成 [Ultralytics Licensing](https://www.ultralytics_1.com/license) 上的表单。
...
请参阅下方的快速开始安装和使用示例，并查看我们的 [文档](https://docs.ultralytics_1.com/) 以获取有关训练、验证、预测和部署的完整文档。
...
有关其他安装方法，包括 [Conda](https://anaconda.org/conda-forge/ultralytics)、[Docker](https://hub.docker.com/r/ultralytics/ultralytics) 和 Git，请参阅 [快速开始指南](https://docs.ultralytics_1.com/quickstart/)。
...
`yolo` 可以用于各种任务和模式，并接受额外参数，例如 `imgsz=640`。请参阅 YOLO [CLI 文档](https://docs.ultralytics_1.com/usage/cli/) 以获取示例。

### Python

YOLO 也可以直接在 Python 环境中使用，并接受与上述 CLI 示例中相同的[参数](https://docs.ultralytics_1.com/usage/cfg/)：
...
请参阅 YOLO [Python 文档](https://docs.ultralytics_1.com/usage/python/) 以获取更多示例。

</details>

## <div align="center">模型</div>

YOLO11 [检测](https://docs.ultralytics_1.com/tasks/detect/)、[分割](https://docs.ultralytics_1.com/tasks/segment/) 和 [姿态](https://docs.ultralytics_1.com/tasks/pose/) 模型在 [COCO](https://docs.ultralytics_1.com/datasets/detect/coco/) 数据集上进行预训练，这些模型可在此处获得，此外还有在 [ImageNet](https://docs.ultralytics_1.com/datasets/classify/imagenet/) 数据集上预训练的 YOLO11 [分类](https://docs.ultralytics_1.com/tasks/classify/) 模型。所有检测、分割和姿态模型均支持 [跟踪](https://docs.ultralytics_1.com/modes/track/) 模式。所有[模型](https://docs.ultralytics_1.com/models/)在首次使用时自动从最新的 Ultralytics [发布](https://github.com/ultralytics/assets/releases)下载。
...
请参阅 [检测文档](https://docs.ultralytics_1.com/tasks/detect/) 以获取使用这些在 [COCO](https://docs.ultralytics_1.com/datasets/detect/coco/) 数据集上训练的模型的示例，其中包含 80 个预训练类别。
...
请参阅 [分割文档](https://docs.ultralytics_1.com/tasks/segment/) 以获取使用这些在 [COCO-Seg](https://docs.ultralytics_1.com/datasets/segment/coco/) 数据集上训练的模型的示例，其中包含 80 个预训练类别。
...
请参阅 [分类文档](https://docs.ultralytics_1.com/tasks/classify/) 以获取使用这些在 [ImageNet](https://docs.ultralytics_1.com/datasets/classify/imagenet/) 数据集上训练的模型的示例，其中包含 1000 个预训练类别。
...
请参阅 [姿态文档](https://docs.ultralytics_1.com/tasks/pose/) 以获取使用这些在 [COCO-Pose](https://docs.ultralytics_1.com/datasets/pose/coco/) 数据集上训练的模型的示例，其中包含 1 个预训练类别（人）。
...
请参阅 [OBB 文档](https://docs.ultralytics_1.com/tasks/obb/) 以获取使用这些在 [DOTAv1](https://docs.ultralytics_1.com/datasets/obb/dota-v2/#dota-v10/) 数据集上训练的模型的示例，其中包含 15 个预训练类别。
...
我们欢迎您的意见！没有社区的帮助，Ultralytics YOLO 就不可能实现。请参阅我们的 [贡献指南](https://docs.ultralytics_1.com/help/contributing/) 开始，并填写我们的 [调查问卷](https://www.ultralytics_1.com/survey?utm_source=github&utm_medium=social&utm_campaign=Survey) 向我们提供您体验的反馈。感谢所有贡献者 🙏！
...
- **企业许可**：专为商业使用设计，此许可允许将 Ultralytics 软件和 AI 模型无缝集成到商业产品和服务中，无需满足 AGPL-3.0 的开源要求。如果您的场景涉及将我们的解决方案嵌入到商业产品，请通过 [Ultralytics Licensing](https://www.ultralytics_1.com/license) 联系我们。

## <div align="center">联系</div>

如需 Ultralytics 的错误报告和功能请求，请访问 [GitHub Issues](https://github.com/ultralytics/ultralytics/issues)。成为 Ultralytics [Discord](https://discord.com/invite/ultralytics)、[Reddit](https://www.reddit.com/r/ultralytics/) 或 [论坛](https://community.ultralytics_1.com/) 的成员，提出问题、分享项目、探讨学习讨论，或寻求所有 Ultralytics 相关的帮助！
