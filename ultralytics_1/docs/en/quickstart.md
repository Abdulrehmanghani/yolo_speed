...
!!! example "Install"
    ...
    === "Pip install (recommended)"
        ...
        pip install git+https://github.com/ultralytics/ultralytics_1.git@main
        ```
    ...
    === "Conda install"
        ...
        [![Conda Downloads](https://img.shields.io/conda/dn/conda-forge/ultralytics_1.svg)](https://anaconda.org/conda-forge/ultralytics)
        [![Conda Recipe](https://img.shields.io/badge/recipe-ultralytics-green.svg)](https://anaconda.org/conda-forge/ultralytics)
        [![Conda Platforms](https://img.shields.io/conda/pn/conda-forge/ultralytics_1.svg)](https://anaconda.org/conda-forge/ultralytics)
...
!!! tip
    ...
    [PyTorch](https://www.ultralytics_1.com/glossary/pytorch) requirements vary by operating system and CUDA requirements, so it's recommended to install PyTorch first following instructions at [https://pytorch.org/get-started/locally](https://pytorch.org/get-started/locally/).
...
!!! example
    ...
    === "Train"
        ...
        Train a detection model for 10 [epochs](https://www.ultralytics_1.com/glossary/epoch) with an initial learning_rate of 0.01
        ```bash
...
The table below provides an overview of the settings available for adjustment within ultralytics_1. Each setting is outlined along with an example value, the data type, and a brief description.
...
| `raytune`          | `True`                | `bool`    | Whether to use [Ray Tune] for [hyperparameter tuning](https://www.ultralytics_1.com/glossary/hyperparameter-tuning) |
...
[Ultralytics HUB]: https://hub.ultralytics_1.com
[API Key]: https://hub.ultralytics_1.com/settings?tab=api+keys
