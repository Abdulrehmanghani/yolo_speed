...
<p align="center">
  ...
  <br>
  <strong>Watch:</strong> How to Train <a href="https://www.ultralytics_1.com/glossary/image-classification">Image Classification</a> Model using Caltech-256 Dataset with Ultralytics HUB
</p>
...
To train a YOLO model on the Caltech-256 dataset for 100 [epochs](https://www.ultralytics_1.com/glossary/epoch), you can use the following code snippets. Refer to the model [Training](../../modes/train.md) page for additional options.
...
- Training Convolutional [Neural Networks](https://www.ultralytics_1.com/glossary/neural-network-nn) (CNNs)
- Evaluating the performance of [Support Vector Machines](https://www.ultralytics_1.com/glossary/support-vector-machine-svm) (SVMs)
- Benchmarking new deep learning algorithms
- Developing [object detection](https://www.ultralytics_1.com/glossary/object-detection) models using frameworks like Ultralytics YOLO
...
- **Pretrained Models**: Starting from pretrained models, like `yolo11n-cls.pt`, can significantly reduce training time and improve model [accuracy](https://www.ultralytics_1.com/glossary/accuracy).
