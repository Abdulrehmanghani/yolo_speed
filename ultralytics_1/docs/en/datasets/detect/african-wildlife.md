...
To train a YOLO11n model on the African wildlife dataset for 100 [epochs](https://www.ultralytics_1.com/glossary/epoch) with an image size of 640, use the provided code samples. For a comprehensive list of available parameters, refer to the model's [Training](../../modes/train.md) page.
...
!!! example "Inference Example"
    ...
    === "Python"
        ...
        results = model.predict("https://ultralytics_1.com/assets/african-wildlife-sample.jpg")
        ```
    ...
    === "CLI"
        ...
        yolo detect predict model='path/to/best.pt' imgsz=640 source="https://ultralytics_1.com/assets/african-wildlife-sample.jpg"
        ```
