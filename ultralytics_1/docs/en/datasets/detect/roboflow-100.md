...
Dataset benchmarking evaluates machine learning model performance on specific datasets using standardized metrics like [accuracy](https://www.ultralytics_1.com/glossary/accuracy), [mean average precision](https://www.ultralytics_1.com/glossary/mean-average-precision-map) and F1-score.
...
!!! example "Benchmarking example"
    ...
    === "Python"
        ...
        from ultralytics_1.utils.benchmarks import RF100Benchmark
...
Roboflow 100 is invaluable for various applications related to [computer vision](https://www.ultralytics_1.com/glossary/computer-vision-cv) and [deep learning](https://www.ultralytics_1.com/glossary/deep-learning-dl). Researchers and engineers can use this benchmark to:
...
If you are interested in exploring more datasets to enhance your object detection and [machine learning](https://www.ultralytics_1.com/glossary/machine-learning-ml) projects, feel free to visit [our comprehensive dataset collection](../index.md).
...
The **Roboflow 100** dataset spans seven domains, each providing unique challenges and applications for [object detection](https://www.ultralytics_1.com/glossary/object-detection) models:
