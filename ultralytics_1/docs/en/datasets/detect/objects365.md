...
To train a YOLO11n model on the Objects365 dataset for 100 [epochs](https://www.ultralytics_1.com/glossary/epoch) with an image size of 640, you can use the following code snippets. For a comprehensive list of available arguments, refer to the model [Training](../../modes/train.md) page.
...
The Objects365 dataset contains a diverse set of high-resolution images with objects from 365 categories, providing rich context for [object detection](https://www.ultralytics_1.com/glossary/object-detection) tasks. Here are some examples of the images in the dataset:
