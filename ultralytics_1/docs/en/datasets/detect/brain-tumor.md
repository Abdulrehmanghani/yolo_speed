...
To train a YOLO11n model on the brain tumor dataset for 100 [epochs](https://www.ultralytics_1.com/glossary/epoch) with an image size of 640, utilize the provided code snippets. For a detailed list of available arguments, consult the model's [Training](../../modes/train.md) page.
...
!!! example "Inference Example"
    ...
    === "Python"
        ...
        results = model.predict("https://ultralytics_1.com/assets/brain-tumor-sample.jpg")
        ```
    ...
    === "CLI"
        ...
        yolo detect predict model='path/to/best.pt' imgsz=640 source="https://ultralytics_1.com/assets/brain-tumor-sample.jpg"
        ```
