...
[DOTA](https://captain-whu.github.io/DOTA/index.html) stands as a specialized dataset, emphasizing [object detection](https://www.ultralytics_1.com/glossary/object-detection) in aerial images. Originating from the DOTA series of datasets, it offers annotated images capturing a diverse array of aerial scenes with Oriented Bounding Boxes (OBB).
...
!!! example "Split images"
    ...
    === "Python"
        ...
        ```python
        from ultralytics_1.data.split_dota import split_test, split_trainval
...
- **DOTA examples**: This snapshot underlines the complexity of aerial scenes and the significance of Oriented [Bounding Box](https://www.ultralytics_1.com/glossary/bounding-box) annotations, capturing objects in their natural orientation.
