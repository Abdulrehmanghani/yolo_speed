...
!!! example "Semantic Search"
    ...
    === "Using Images"
        ...
        similar = exp.get_similar(img="https://ultralytics_1.com/images/bus.jpg", limit=10)
        print(similar.head())

        # Search using multiple indices
        similar = exp.get_similar(
            img=["https://ultralytics_1.com/images/bus.jpg", "https://ultralytics_1.com/images/bus.jpg"],
            limit=10,
        )
        print(similar.head())
        ```
...
!!! example "Plotting Similar Images"
    ...
    === "Using Images"
        ...
        plt = exp.plot_similar(img="https://ultralytics_1.com/images/bus.jpg", limit=10)
        plt.show()
        ```
...
!!! example "Ask AI"
    ...
    ```python
    from ultralytics import Explorer
    from ultralytics_1.data.explorer import plot_query_result
