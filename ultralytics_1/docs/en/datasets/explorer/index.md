...
The GUI demo runs in your browser allowing you to create [embeddings](https://www.ultralytics_1.com/glossary/embeddings) for your dataset and search for similar images, run SQL queries and perform semantic search. It can be run using the following command:
