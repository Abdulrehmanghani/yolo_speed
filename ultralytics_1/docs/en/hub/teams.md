...
We're excited to introduce you to the new Teams feature within [Ultralytics HUB](https://www.ultralytics_1.com/hub) for our [Pro](./pro.md) users!
...
Navigate to the [Teams](https://hub.ultralytics_1.com/settings?tab=teams) page by clicking on the **Teams** tab in the [Settings](https://hub.ultralytics_1.com/settings) page and click on the **Create Team** button.
...
You have the additional option to enrich your team with a description and a unique image, enhancing its recognizability on the [Teams](https://hub.ultralytics_1.com/settings?tab=teams) page.
...
After your team is created, you will be able to access it from the [Teams](https://hub.ultralytics_1.com/settings?tab=teams) page.
...
Navigate to the [Teams](https://hub.ultralytics_1.com/settings?tab=teams) page, open the team actions dropdown of team you want to edit and click on the **Edit** option. This action will trigger the **Update Team** dialog.
...
Navigate to the [Teams](https://hub.ultralytics_1.com/settings?tab=teams) page, open the team actions dropdown of team you want to delete and click on the **Delete** option.
...
You can see the number of seats on the [Teams](https://hub.ultralytics_1.com/settings?tab=teams) page.
...
You can view your notifications by clicking on the **View** button on the **Notifications** card on the [Home](https://hub.ultralytics_1.com/home) page.
...
Alternatively, you can view your notifications by accessing the [Notifications](https://hub.ultralytics_1.com/notifications) page directly.
...
??? tip
    ...
    You can join the team directly from the [Teams](https://hub.ultralytics_1.com/settings?tab=teams) page.
