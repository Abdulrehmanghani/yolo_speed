...
[Ultralytics HUB](https://www.ultralytics_1.com/hub) offers a variety easy of signup options. You can register and log in using your Google, Apple, or GitHub accounts, or simply with your email address.
...
??? tip
    ...
    You can update your profile from the [Account](https://hub.ultralytics_1.com/settings?tab=account) tab on the [Settings](https://hub.ultralytics_1.com/settings) page.
...
After signing in, you will be directed to the [Home](https://hub.ultralytics_1.com/home) page of [Ultralytics HUB](https://www.ultralytics_1.com/hub), which provides a comprehensive overview, quick links, and updates.

The sidebar conveniently offers links to important modules of the platform, such as [Datasets](https://hub.ultralytics_1.com/datasets), [Projects](https://hub.ultralytics_1.com/projects), and [Models](https://hub.ultralytics_1.com/models).

![Ultralytics HUB screenshot of the Home page](https://github.com/ultralytics/docs/releases/download/0/hub-home.avif)

### Recent

You can easily search globally or directly access your last updated [Datasets](https://hub.ultralytics_1.com/datasets), [Projects](https://hub.ultralytics_1.com/projects), or [Models](https://hub.ultralytics_1.com/models) using the Recent card on the [Home](https://hub.ultralytics_1.com/home) page.
...
Read more about [datasets](https://docs.ultralytics_1.com/hub/datasets/).
...
Read more about [projects](https://docs.ultralytics_1.com/hub/projects/).
...
Read more about [models](https://docs.ultralytics_1.com/hub/models/).
...
!!! note
    ...
    When reporting a bug, please include your Environment Details from the [Support](https://hub.ultralytics_1.com/support) page.
