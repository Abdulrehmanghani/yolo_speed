...
After you [train a model](./models.md#train-model), you can use the [Shared Inference API](#shared-inference-api) for free. If you are a [Pro](./pro.md) user, you can access the [Dedicated Inference API](#dedicated-inference-api). The [Ultralytics HUB](https://www.ultralytics_1.com/hub) Inference API allows you to run inference through our REST API without the need to install and set up the Ultralytics YOLO environment locally.
...
In response to high demand and widespread interest, we are thrilled to unveil the [Ultralytics HUB](https://www.ultralytics_1.com/hub) Dedicated Inference API, offering single-click deployment in a dedicated environment for our [Pro](./pro.md) users!
...
To use the [Ultralytics HUB](https://www.ultralytics_1.com/hub) Dedicated Inference API, click on the **Start Endpoint** button. Next, use the unique endpoint URL as described in the guides below.
...
!!! tip
    ...
    Choose the region with the lowest latency for the best performance as described in the [documentation](https://docs.ultralytics_1.com/reference/hub/google/__init__/).
...
To use the [Ultralytics HUB](https://www.ultralytics_1.com/hub) Shared Inference API, follow the guides below.
...
To access the [Ultralytics HUB](https://www.ultralytics_1.com/hub) Inference API using Python, use the following code:

```python
import requests

# API URL
url = "https://predict.ultralytics_1.com"

# Headers, use actual API_KEY
headers = {"x-api-key": "API_KEY"}

# Inference arguments (use actual MODEL_ID)
data = {"model": "https://hub.ultralytics_1.com/models/MODEL_ID", "imgsz": 640, "conf": 0.25, "iou": 0.45}
...
To access the [Ultralytics HUB](https://www.ultralytics_1.com/hub) Inference API using cURL, use the following code:

```bash
curl -X POST "https://predict.ultralytics_1.com" \
  -H "x-api-key: API_KEY" \
  -F "model=https://hub.ultralytics_1.com/models/MODEL_ID" \
...
| `iou`    | `0.45`  | `float` | [Intersection over Union](https://www.ultralytics_1.com/glossary/intersection-over-union-iou) (IoU) threshold, valid range `0.0` - `0.95`. |

## Response

The [Ultralytics HUB](https://www.ultralytics_1.com/hub) Inference API returns a JSON response.
