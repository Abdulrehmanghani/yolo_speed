...
Navigate to the [Models](https://hub.ultralytics_1.com/models) page by clicking on the **Models** button in the sidebar and click on the **Train Model** button on the top right of the page.
...
??? tip
    ...
    You can train a model directly from the [Home](https://hub.ultralytics_1.com/home) page.
...
??? note
    ...
    If you opened the **Train Model** dialog as described above, [Ultralytics HUB](https://www.ultralytics_1.com/hub) will pre-select the last project you used.

    If you opened the **Train Model** dialog from the Project page, [Ultralytics HUB](https://www.ultralytics_1.com/hub) will pre-select the project you were inside of.
...
!!! info
    ...
    You can read more about the available [YOLO models](https://docs.ultralytics_1.com/models/) and architectures in our documentation.

By default, your model will use a pre-trained model (trained on the [COCO](https://docs.ultralytics_1.com/datasets/detect/coco/) dataset) to reduce training time. You can change this behavior and tweak your model's configuration by opening the **Advanced Model Configuration** accordion.
...
!!! note
    ...
    You can easily change the most common model configuration options (such as the number of epochs) but you can also use the **Custom** option to access all [Train Settings](https://docs.ultralytics_1.com/modes/train/#train-settings) relevant to [Ultralytics HUB](https://www.ultralytics_1.com/hub).
...
[Ultralytics HUB](https://www.ultralytics_1.com/hub) offers three training options:
...
To start training your model using your own agent, follow the instructions shown in the [Ultralytics HUB](https://www.ultralytics_1.com/hub) **Train Model** dialog.
...
Furthermore, you can preview your model in real-time directly on your [iOS](https://apps.apple.com/xk/app/ultralytics/id1583935240) or [Android](https://play.google.com/store/apps/details?id=com.ultralytics_1.ultralytics_app) mobile device by [downloading](https://www.ultralytics_1.com/app-install) our [Ultralytics HUB App](app/index.md).
...
After you [train a model](#train-model), you can export it to 13 different formats, including ONNX, OpenVINO, CoreML, [TensorFlow](https://www.ultralytics_1.com/glossary/tensorflow), Paddle and many others.
...
!!! info
    ...
    [Ultralytics HUB](https://www.ultralytics_1.com/hub)'s sharing functionality provides a convenient way to share models with others. This feature is designed to accommodate both existing [Ultralytics HUB](https://www.ultralytics_1.com/hub) users and those who have yet to create an account.

??? note

    You have control over the general access of your models.

    You can choose to set the general access to "Private", in which case, only you will have access to it. Alternatively, you can set the general access to "Unlisted" which grants viewing access to anyone who has the direct link to the model, regardless of whether they have an [Ultralytics HUB](https://www.ultralytics_1.com/hub) account or not.
...
??? tip
    ...
    You can also share a model directly from the [Models](https://hub.ultralytics_1.com/models) page or from the Project page of the project where your model is located.
...
??? tip
    ...
    You can also edit a model directly from the [Models](https://hub.ultralytics_1.com/models) page or from the Project page of the project where your model is located.
...
??? tip
    ...
    You can also delete a model directly from the [Models](https://hub.ultralytics_1.com/models) page or from the Project page of the project where your model is located.
...
!!! note
    ...
    If you change your mind, you can restore the model from the [Trash](https://hub.ultralytics_1.com/trash) page.
