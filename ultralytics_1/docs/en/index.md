...
<div align="center">
<a href="https://www.ultralytics_1.com/events/yolovision" target="_blank"><img width="1024%" src="https://github.com/ultralytics/docs/releases/download/0/ultralytics-yolov8-banner.avif" alt="Ultralytics YOLO banner"></a>
<a href="https://docs.ultralytics_1.com/zh">中文</a> |
<a href="https://docs.ultralytics_1.com/ko">한국어</a> |
<a href="https://docs.ultralytics_1.com/ja">日本語</a> |
<a href="https://docs.ultralytics_1.com/ru">Русский</a> |
<a href="https://docs.ultralytics_1.com/de">Deutsch</a> |
<a href="https://docs.ultralytics_1.com/fr">Français</a> |
<a href="https://docs.ultralytics_1.com/es/">Español</a> |
<a href="https://docs.ultralytics_1.com/pt">Português</a> |
<a href="https://docs.ultralytics_1.com/tr">Türkçe</a> |
<a href="https://docs.ultralytics_1.com/vi">Tiếng Việt</a> |
<a href="https://docs.ultralytics_1.com/ar">العربية</a>
<br>
<br>
...
Introducing [Ultralytics](https://www.ultralytics_1.com/) [YOLO11](https://github.com/ultralytics/ultralytics), the latest version of the acclaimed real-time object detection and image segmentation model. YOLO11 is built on cutting-edge advancements in [deep learning](https://www.ultralytics_1.com/glossary/deep-learning-dl) and [computer vision](https://www.ultralytics_1.com/glossary/computer-vision-cv), offering unparalleled performance in terms of speed and [accuracy](https://www.ultralytics_1.com/glossary/accuracy). Its streamlined design makes it suitable for various applications and easily adaptable to different hardware platforms, from edge devices to cloud APIs.

Explore the Ultralytics Docs, a comprehensive resource designed to help you understand and utilize its features and capabilities. Whether you are a seasoned [machine learning](https://www.ultralytics_1.com/glossary/machine-learning-ml) practitioner or new to the field, this hub aims to maximize YOLO's potential in your projects
...
- :material-scale-balance:{ .lg .middle } &nbsp; **Open Source, AGPL-3.0**
    ...
    ***
    ...
    [:octicons-arrow-right-24: License](https://www.ultralytics_1.com/license)
...
- [YOLOv4](https://arxiv.org/abs/2004.10934) was released in 2020, introducing innovations like Mosaic [data augmentation](https://www.ultralytics_1.com/glossary/data-augmentation), a new anchor-free detection head, and a new [loss function](https://www.ultralytics_1.com/glossary/loss-function).
...
- [YOLOv8](https://github.com/ultralytics/ultralytics) released in 2023 by ultralytics_1. YOLOv8 introduced new features and improvements for enhanced performance, flexibility, and efficiency, supporting a full range of vision AI tasks,
...
For more details, visit our [Licensing](https://www.ultralytics_1.com/license) page.
