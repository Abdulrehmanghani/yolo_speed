---
description: Explore the DetectionValidator class for YOLO models in ultralytics_1. Learn validation techniques, metrics, and dataset handling for object detection.
...
## ::: ultralytics_1.models.yolo.detect.val.DetectionValidator
