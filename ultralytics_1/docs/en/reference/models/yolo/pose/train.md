---
description: Explore the PoseTrainer class for training pose models using YOLO from ultralytics_1. Includes initialization, model configuration, and plotting methods.
...
## ::: ultralytics_1.models.yolo.pose.train.PoseTrainer
