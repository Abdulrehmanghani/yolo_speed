---
description: Discover how to use the FastSAM model with ultralytics_1. Learn about its interface and implementation details with practical examples.
...
## ::: ultralytics_1.models.fastsam.model.FastSAM
