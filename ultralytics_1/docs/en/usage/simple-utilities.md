...
Dataset annotation is a very resource intensive and time-consuming process. If you have a YOLO [object detection](https://www.ultralytics_1.com/glossary/object-detection) model trained on a reasonable amount of data, you can use it and [SAM](../models/sam.md) to auto-annotate additional data (segmentation format).
...
- [See the reference section for `annotator.auto_annotate`](../reference/data/annotator.md#ultralytics_1.data.annotator.auto_annotate) for more insight on how the function operates.
...
```python
from ultralytics_1.data.converter import convert_segment_masks_to_yolo_seg
...
For additional information about the `convert_coco` function, [visit the reference page](../reference/data/converter.md#ultralytics_1.data.converter.convert_coco)

### Get [Bounding Box](https://www.ultralytics_1.com/glossary/bounding-box) Dimensions
...
```{ .py .annotate }
from ultralytics_1.data.converter import yolo_bbox2segment
...
[Visit the `yolo_bbox2segment` reference page](../reference/data/converter.md#ultralytics_1.data.converter.yolo_bbox2segment) for more information regarding the function.
...
To understand how this function works, visit the [reference page](../reference/utils/ops.md#ultralytics_1.utils.ops.segments2boxes)
...
from ultralytics_1.data.utils import compress_one_image
...
```{ .py .annotate }
from ultralytics_1.data.utils import autosplit
...
See the [Reference page](../reference/data/utils.md#ultralytics_1.data.utils.autosplit) for additional details on this function.
...
from ultralytics_1.data.utils import polygon2mask
...
from ultralytics_1.utils.instance import Bboxes
...
See the [`Bboxes` reference section](../reference/utils/instance.md#ultralytics_1.utils.instance.Bboxes) for more attributes and methods available.
...
When scaling and image up or down, corresponding bounding box coordinates can be appropriately scaled to match using `ultralytics_1.utils.ops.scale_boxes`.

```{ .py .annotate }
import cv2 as cv
import numpy as np

from ultralytics_1.utils.ops import scale_boxes
...
```python
from ultralytics_1.utils.ops import (
    ltwh2xywh,
    ltwh2xyxy,
...
See docstring for each function or visit the `ultralytics_1.utils.ops` [reference page](../reference/utils/ops.md) to read more about each function.
...
!!! example "Python Examples using YOLO11 🚀"
    ...
    video_writer = cv2.VideoWriter("ultralytics_1.avi", cv2.VideoWriter_fourcc(*"mp4v"), fps, (w, h))
...
#### Bounding Boxes Circle Annotation [Circle Label](https://docs.ultralytics_1.com/reference/utils/plotting/#ultralytics_1.utils.plotting.Annotator.circle_label)
...
#### Bounding Boxes Text Annotation [Text Label](https://docs.ultralytics_1.com/reference/utils/plotting/#ultralytics_1.utils.plotting.Annotator.text_label)
...
See the [`Annotator` Reference Page](../reference/utils/plotting.md#ultralytics_1.utils.plotting.Annotator) for additional insight.
...
```python
from ultralytics_1.data.utils import IMG_FORMATS, VID_FORMATS
...
```python
from ultralytics_1.utils.ops import make_divisible
...
### What utilities are included in the Ultralytics package to enhance [machine learning](https://www.ultralytics_1.com/glossary/machine-learning-ml) workflows?

The Ultralytics package includes a variety of utilities designed to streamline and optimize machine learning workflows. Key utilities include [auto-annotation](../reference/data/annotator.md#ultralytics_1.data.annotator.auto_annotate) for labeling datasets, converting COCO to YOLO format with [convert_coco](../reference/data/converter.md#ultralytics_1.data.converter.convert_coco), compressing images, and dataset auto-splitting. These tools aim to reduce manual effort, ensure consistency, and enhance data processing efficiency.
...
For more details, check the [auto_annotate reference section](../reference/data/annotator.md#ultralytics_1.data.annotator.auto_annotate).
...
For additional information, visit the [convert_coco reference page](../reference/data/converter.md#ultralytics_1.data.converter.convert_coco).
...
For more information, visit the [yolo_bbox2segment reference page](../reference/data/converter.md#ultralytics_1.data.converter.yolo_bbox2segment).
