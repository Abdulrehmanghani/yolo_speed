...
!!! example
    ...
    === "Official"
        ...
        ```bash
        yolo detect predict model=yolo11n.pt source='https://ultralytics_1.com/images/bus.jpg'
        ```
    ...
    === "Custom"
        ...
        ```bash
        yolo detect predict model=path/to/best.pt source='https://ultralytics_1.com/images/bus.jpg'
        ```
...
To train a YOLO11 model using the CLI, you can execute a simple one-line command in the terminal. For example, to train a detection model for 10 epochs with a [learning rate](https://www.ultralytics_1.com/glossary/learning-rate) of 0.01, you would run:
...
To validate a YOLO11 model's accuracy, use the `val` mode. For example, to validate a pretrained detection model with a [batch size](https://www.ultralytics_1.com/glossary/batch-size) of 1 and image size of 640, run:
