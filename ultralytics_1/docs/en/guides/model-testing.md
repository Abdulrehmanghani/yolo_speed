...
Model testing is quite similar to model evaluation, but they are two distinct [steps in a computer vision project](./steps-of-a-cv-project.md). Model evaluation involves metrics and plots to assess the model's accuracy. On the other hand, model testing checks if the model's learned behavior is the same as expectations. In this guide, we'll explore strategies for testing your [computer vision](https://www.ultralytics_1.com/glossary/computer-vision-cv) models.
...
Computer vision models learn from datasets by detecting patterns, making predictions, and evaluating their performance. These [datasets](./preprocessing_annotated_data.md) are usually divided into training and testing sets to simulate real-world conditions. [Training data](https://www.ultralytics_1.com/glossary/training-data) teaches the model while testing data verifies its accuracy.
...
## Overfitting and [Underfitting](https://www.ultralytics_1.com/glossary/underfitting) in [Machine Learning](https://www.ultralytics_1.com/glossary/machine-learning-ml)
...
- **High Training Accuracy, Low Validation Accuracy:** If your model performs very well on training data but poorly on validation or [test data](https://www.ultralytics_1.com/glossary/test-data), it's likely overfitting.
...
- **Spatial Bias:** Imbalances in foreground-background, [bounding box](https://www.ultralytics_1.com/glossary/bounding-box) distributions, and object locations can affect training.
...
- [Regularization](https://www.ultralytics_1.com/glossary/regularization) techniques like dropout.
...
- Increase training iterations or [epochs](https://www.ultralytics_1.com/glossary/epoch).
...
- [Hyperparameter tuning](https://www.ultralytics_1.com/glossary/hyperparameter-tuning).
