...
# A Practical Guide for Defining Your [Computer Vision](https://www.ultralytics_1.com/glossary/computer-vision-cv) Project
...
- To achieve at least 95% [accuracy](https://www.ultralytics_1.com/glossary/accuracy) in speed detection within six months, using a dataset of 10,000 vehicle images.
...
- **Unique or Limited Data**: If your project is constrained by unique or limited data, begin with dataset preparation. For instance, if you have a rare dataset of medical images, annotate and prepare the data first. Then, select a model that performs well on such data, followed by choosing a suitable training approach.
    ...
    - **Example**: Prepare the data first for a facial recognition system with a small dataset. Annotate it, then select a model that works well with limited data, such as a pre-trained model for [transfer learning](https://www.ultralytics_1.com/glossary/transfer-learning). Finally, decide on a training approach, including [data augmentation](https://www.ultralytics_1.com/glossary/data-augmentation), to expand the dataset.
...
The most popular computer vision tasks include [image classification](https://www.ultralytics_1.com/glossary/image-classification), [object detection](https://www.ultralytics_1.com/glossary/object-detection), and [image segmentation](https://www.ultralytics_1.com/glossary/image-segmentation).
...
- **On-Premise Servers**: For scenarios requiring high [data privacy](https://www.ultralytics_1.com/glossary/data-privacy) and security, deploying on-premise might be necessary. This involves significant upfront hardware investment but allows full control over the data and infrastructure.
...
- **Edge Devices:** Use lightweight models like [TensorFlow](https://www.ultralytics_1.com/glossary/tensorflow) Lite or ONNX Runtime for deployment on devices with limited resources.
