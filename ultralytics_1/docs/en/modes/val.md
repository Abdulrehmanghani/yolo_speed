...
Validation is a critical step in the [machine learning](https://www.ultralytics_1.com/glossary/machine-learning-ml) pipeline, allowing you to assess the quality of your trained models. Val mode in Ultralytics YOLO11 provides a robust suite of tools and metrics for evaluating the performance of your [object detection](https://www.ultralytics_1.com/glossary/object-detection) models. This guide serves as a complete resource for understanding how to effectively use the Val mode to ensure that your models are both accurate and reliable.
...
- **[Hyperparameter Tuning](https://www.ultralytics_1.com/glossary/hyperparameter-tuning):** Use validation metrics to fine-tune your model for better performance.
...
Validate trained YOLO11n model [accuracy](https://www.ultralytics_1.com/glossary/accuracy) on the COCO8 dataset. No arguments are needed as the `model` retains its training `data` and arguments as model attributes. See Arguments section below for a full list of export arguments.
...
To validate your YOLO11 model, you can use the Val mode provided by ultralytics_1. For example, using the Python API, you can load a model and run validation with:
...
- **[Precision](https://www.ultralytics_1.com/glossary/precision):** YOLO11 offers accurate performance metrics including mAP50, mAP75, and mAP50-95.
...
Yes, you can validate your YOLO11 model using a [custom dataset](https://docs.ultralytics_1.com/datasets/). Specify the `data` argument with the path to your dataset configuration file. This file should include paths to the [validation data](https://www.ultralytics_1.com/glossary/validation-data), class names, and other relevant details.
