...
!!! example "Usage"
    ...
    === "Python"
          ...
          # Run inference
          results = mnn_model("https://ultralytics_1.com/images/bus.jpg")
          ```
    ...
    === "CLI"
          ...
          yolo predict model='yolo11n.mnn' source='https://ultralytics_1.com/images/bus.jpg'
          ```
...
!!! example "Predict"
    ...
    === "Python"
        ...
        # Export to MNN format
        results = mnn_model("https://ultralytics_1.com/images/bus.jpg")  # predict with `fp32`
        results = mnn_model("https://ultralytics_1.com/images/bus.jpg", half=True)  # predict with `fp16` if device support
    ...
    === "CLI"
        ...
        ```bash
        yolo predict model='yolo11n.mnn' source='https://ultralytics_1.com/images/bus.jpg'              # predict with `fp32`
        yolo predict model='yolo11n.mnn' source='https://ultralytics_1.com/images/bus.jpg' --half=True  # predict with `fp16` if device support
        ```
