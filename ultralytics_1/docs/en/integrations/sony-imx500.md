...
!!! example
    ...
    === "Python"
         ...
         # Run inference
         results = imx_model("https://ultralytics_1.com/images/bus.jpg")
         ```
    ...
    === "CLI"
         ...
         yolo predict model=yolov8n_imx_model source='https://ultralytics_1.com/images/bus.jpg'
         ```
