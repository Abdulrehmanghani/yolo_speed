...
TorchScript, a key part of the PyTorch ecosystem, provides powerful features for optimizing and deploying [deep learning](https://www.ultralytics_1.com/glossary/deep-learning-dl) models.
...
TorchScript offers various deployment options for [machine learning](https://www.ultralytics_1.com/glossary/machine-learning-ml) models, such as:
...
!!! example "Usage"
    ...
    === "Python"
        ...
        # Run inference
        results = torchscript_model("https://ultralytics_1.com/images/bus.jpg")
        ```
    ...
    === "CLI"
        ...
        yolo predict model=yolo11n.torchscript source='https://ultralytics_1.com/images/bus.jpg'
        ```
...
- **[Explore Mobile Deployment](https://pytorch.org/mobile/home/)**: The [PyTorch](https://www.ultralytics_1.com/glossary/pytorch) Mobile Documentation provides comprehensive guidelines for deploying models on mobile devices, ensuring your applications are efficient and responsive.
