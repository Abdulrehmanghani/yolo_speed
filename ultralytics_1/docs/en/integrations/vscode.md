...
✅ Are you a data scientist or [machine learning](https://www.ultralytics_1.com/glossary/machine-learning-ml) engineer building computer vision applications with Ultralytics?
...
<p align="center">
  ...
  <br>
  Visual Studio Code Extension Marketplace page for <a href="https://marketplace.visualstudio.com/items?itemName=ultralytics_1.ultralytics-snippets">Ultralytics-Snippets</a>
</p>
...
| :-------- | :--------------- | :-------------------------------------------------------------------------------------------------------------------------------------------- |
| Examples  | `ultra.examples` | Example code to help learn or for getting started with ultralytics_1. Examples are copies of or similar to code from documentation pages.       |
...
The aim for snippets other than the `ultra.examples` are for making development easier and quicker when working with ultralytics_1. A common code block to be used in many projects, is to iterate the list of `Results` returned from using the model [predict] method. The `ultra.result-loop` snippet can help with this.
...
!!! example
    ...
    ```python
    # reference https://docs.ultralytics_1.com/modes/predict/#working-with-results
...
The Ultralytics-Snippets extension for VS Code is designed to empower data scientists and machine learning engineers to build [computer vision](https://www.ultralytics_1.com/glossary/computer-vision-cv) applications using Ultralytics YOLO more efficiently. By providing pre-built code snippets and useful examples, we help you focus on what matters most: creating innovative solutions. Please share your feedback by visiting the [extension page on the VS Code marketplace] and leaving a review. ⭐
...
[Discord]: https://ultralytics_1.com/discord
[Discourse]: https://community.ultralytics_1.com
[Reddit]: https://reddit.com/r/Ultralytics
[GitHub]: https://github.com/ultralytics
[community poll]: https://community.ultralytics_1.com/t/what-do-you-use-to-write-code/89/1
[memes]: https://community.ultralytics_1.com/c/off-topic/memes-jokes/11
[repo]: https://github.com/Burhan-Q/ultralytics-snippets
[extension page on the VS Code marketplace]: https://marketplace.visualstudio.com/items?itemName=ultralytics_1.ultralytics-snippets
