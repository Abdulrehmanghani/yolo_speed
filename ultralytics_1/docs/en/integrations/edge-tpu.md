...
Exporting models to [TensorFlow](https://www.ultralytics_1.com/glossary/tensorflow) Edge TPU makes [machine learning](https://www.ultralytics_1.com/glossary/machine-learning-ml) tasks fast and efficient. This technology suits applications with limited power, computing resources, and connectivity. The Edge TPU is a hardware accelerator by Google. It speeds up TensorFlow Lite models on edge devices. The image below shows an example of the process involved.
...
!!! example "Usage"
    ...
    === "Python"
        ...
        # Run inference
        results = edgetpu_model("https://ultralytics_1.com/images/bus.jpg")
        ```
    ...
    === "CLI"
        ...
        yolo predict model=yolo11n_full_integer_quant_edgetpu.tflite source='https://ultralytics_1.com/images/bus.jpg'
        ```
...
In this guide, we've learned how to export Ultralytics YOLO11 models to TFLite Edge TPU format. By following the steps mentioned above, you can increase the speed and power of your [computer vision](https://www.ultralytics_1.com/glossary/computer-vision-cv) applications.
...
This makes it ideal for applications in [edge computing](https://www.ultralytics_1.com/glossary/edge-computing), where devices have limited power and computational resources. Learn more about [why you should export](#why-should-you-export-to-tflite-edge-tpu).
