...
!!! example "Usage"
    ...
    === "Python"
        ...
        # Run inference
        results = tfjs_model("https://ultralytics_1.com/images/bus.jpg")
        ```
    ...
    === "CLI"
        ...
        yolo predict model='./yolo11n_web_model' source='https://ultralytics_1.com/images/bus.jpg'
        ```
