...
Deploying [machine learning](https://www.ultralytics_1.com/glossary/machine-learning-ml) models can be challenging. However, using an efficient and flexible model format can make your job easier. TF SavedModel is an open-source machine-learning framework used by TensorFlow to load machine-learning models in a consistent way. It is like a suitcase for TensorFlow models, making them easy to carry and use on different devices and systems.
...
!!! example "Usage"
    ...
    === "Python"
        ...
        # Run inference
        results = tf_savedmodel_model("https://ultralytics_1.com/images/bus.jpg")
        ```
    ...
    === "CLI"
        ...
        yolo predict model='./yolo11n_saved_model' source='https://ultralytics_1.com/images/bus.jpg'
        ```
...
The TensorFlow SavedModel format offers several advantages for [model deployment](https://www.ultralytics_1.com/glossary/model-deployment):
