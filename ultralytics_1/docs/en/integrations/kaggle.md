...
To get started, access the [Kaggle YOLO11 Notebook](https://www.kaggle.com/code/glennjocherultralytics/yolo11). Kaggle's environment comes with pre-installed libraries like [TensorFlow](https://www.ultralytics_1.com/glossary/tensorflow) and [PyTorch](https://www.ultralytics_1.com/glossary/pytorch), making the setup process hassle-free.
...
Interested in more YOLO11 integrations? Check out the[ Ultralytics integration guide](https://docs.ultralytics_1.com/integrations/) to explore additional tools and capabilities for your machine learning projects.
...
For more details, visit our [Ultralytics integration guide](https://docs.ultralytics_1.com/integrations/).
