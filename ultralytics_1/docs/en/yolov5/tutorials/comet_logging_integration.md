...
Comet builds tools that help data scientists, engineers, and team leaders accelerate and optimize [machine learning](https://www.ultralytics_1.com/glossary/machine-learning-ml) and [deep learning](https://www.ultralytics_1.com/glossary/deep-learning-dl) models.
...
- Box Loss, Object Loss, Classification Loss for the training and [validation data](https://www.ultralytics_1.com/glossary/validation-data)
...
- [Confusion Matrix](https://www.ultralytics_1.com/glossary/confusion-matrix) of the model predictions on the validation data
...
You can control the frequency of logged predictions and the associated images by passing the `bbox_interval` command line argument. Predictions can be visualized using Comet's [Object Detection](https://www.ultralytics_1.com/glossary/object-detection) Custom Panel. This frequency corresponds to every Nth batch of data per [epoch](https://www.ultralytics_1.com/glossary/epoch). In the example below, we are logging every 2nd batch of data for each epoch.

**Note:** The YOLOv5 validation dataloader will default to a [batch size](https://www.ultralytics_1.com/glossary/batch-size) of 32, so you will have to set the logging frequency accordingly.
...
Use the `COMET_LOG_PER_CLASS_METRICS` environment variable to log mAP, [precision](https://www.ultralytics_1.com/glossary/precision), [recall](https://www.ultralytics_1.com/glossary/recall), f1 for each class.
