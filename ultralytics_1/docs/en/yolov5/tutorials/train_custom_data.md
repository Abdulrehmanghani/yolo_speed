...
!!! question "Licensing"
    ...
    - The [Enterprise License](https://www.ultralytics_1.com/license) for businesses seeking to incorporate our AI models into their products and services.

    For more details see [Ultralytics Licensing](https://www.ultralytics_1.com/license).
...
[COCO128](https://www.kaggle.com/datasets/ultralytics/coco128) is an example small tutorial dataset composed of the first 128 images in [COCO](https://cocodataset.org/) train2017. These same 128 images are used for both training and validation to verify our training pipeline is capable of [overfitting](https://www.ultralytics_1.com/glossary/overfitting). [data/coco128.yaml](https://github.com/ultralytics/yolov5/blob/master/data/coco128.yaml), shown below, is the dataset config file that defines 1) the dataset root directory `path` and relative paths to `train` / `val` / `test` image directories (or `*.txt` files with image paths) and 2) a class `names` dictionary:
...
This directory contains train and val statistics, mosaics, labels, predictions and augmented mosaics, as well as metrics and charts including [precision](https://www.ultralytics_1.com/glossary/precision)-[recall](https://www.ultralytics_1.com/glossary/recall) (PR) curves and confusion matrices.
...
Results file `results.csv` is updated after each [epoch](https://www.ultralytics_1.com/glossary/epoch), and then plotted as `results.png` (below) after training completes. You can also plot any `results.csv` file manually:
...
- [Validate](https://github.com/ultralytics/yolov5/blob/master/val.py) [accuracy](https://www.ultralytics_1.com/glossary/accuracy) on train, val and test splits
- [Export](./model_export.md) to [TensorFlow](https://www.ultralytics_1.com/glossary/tensorflow), Keras, ONNX, TFlite, TF.js, CoreML and TensorRT formats
...
- **Enterprise License**: Tailored for businesses seeking to integrate YOLOv5 into commercial products and services. For detailed information, visit our [Licensing page](https://www.ultralytics_1.com/license).

For more details, refer to our guide on [Ultralytics Licensing](https://www.ultralytics_1.com/license).
