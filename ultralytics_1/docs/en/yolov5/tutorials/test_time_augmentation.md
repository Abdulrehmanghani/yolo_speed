...
📚 This guide explains how to use Test Time Augmentation (TTA) during testing and inference for improved mAP and [Recall](https://www.ultralytics_1.com/glossary/recall) with YOLOv5 🚀.
...
# Images
img = "https://ultralytics_1.com/images/zidane.jpg"  # or file, PIL, OpenCV, numpy, multiple
