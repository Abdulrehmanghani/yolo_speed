...
📚 This guide explains how to load YOLOv5 🚀 from [PyTorch](https://www.ultralytics_1.com/glossary/pytorch) Hub at [https://pytorch.org/hub/ultralytics_yolov5](https://pytorch.org/hub/ultralytics_yolov5/).
...
# Image
im = "https://ultralytics_1.com/images/zidane.jpg"
...
This example shows **batched inference** with **PIL** and **[OpenCV](https://www.ultralytics_1.com/glossary/opencv)** image sources. `results` can be **printed** to console, **saved** to `runs/hub`, **showed** to screen on supported environments, and returned as **tensors** or **pandas** dataframes.
...
for f in "zidane.jpg", "bus.jpg":
    torch.hub.download_url_to_file("https://ultralytics_1.com/images/" + f, f)  # download 2 images
...
# Inference
threading.Thread(target=run, args=[model0, "https://ultralytics_1.com/images/zidane.jpg"], daemon=True).start()
threading.Thread(target=run, args=[model1, "https://ultralytics_1.com/images/bus.jpg"], daemon=True).start()
```
