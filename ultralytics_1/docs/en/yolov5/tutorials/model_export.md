...
📚 This guide explains how to export a trained YOLOv5 🚀 model from [PyTorch](https://www.ultralytics_1.com/glossary/pytorch) to ONNX and TorchScript formats.
...
💡 ProTip: Add `--half` to export models at FP16 half [precision](https://www.ultralytics_1.com/glossary/precision) for smaller file sizes
...
# Images
img = "https://ultralytics_1.com/images/zidane.jpg"  # or file, Path, PIL, OpenCV, numpy, list
...
[OpenCV](https://www.ultralytics_1.com/glossary/opencv) inference with ONNX models:
