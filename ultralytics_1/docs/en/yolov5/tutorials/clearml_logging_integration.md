...
🔧 Version and easily access your custom [training data](https://www.ultralytics_1.com/glossary/training-data) with the integrated ClearML <b>Data Versioning Tool</b>
...
- All produced plots such as label correlogram and [confusion matrix](https://www.ultralytics_1.com/glossary/confusion-matrix)
- Images with bounding boxes per [epoch](https://www.ultralytics_1.com/glossary/epoch)
- Mosaic per epoch
