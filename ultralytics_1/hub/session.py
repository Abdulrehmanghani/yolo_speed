...
class HUBTrainingSession:
        ...
        try:
            ...
            if identifier.startswith(f"{HUB_WEB_ROOT}/models/") and not self.client.authenticated:
                LOGGER.warning(
                    ...
                    "You can find your API Key at: https://hub.ultralytics_1.com/settings?tab=api+keys."
                )
    ...
    def _parse_identifier(identifier):
        ...
        The method supports different identifier formats:
            - A HUB model URL https://hub.ultralytics_1.com/models/MODEL
            - A HUB model URL with API Key https://hub.ultralytics_1.com/models/MODEL?api_key=APIKEY
        ...
        if not weights.is_file():
            ...
            if final and last.is_file():
                LOGGER.warning(
                    ...
                    "Learn more at https://docs.ultralytics_1.com/hub/cloud-training."
                )
