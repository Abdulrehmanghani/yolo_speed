...
class Model(nn.Module):
    ...
    def __init__(
        ...
        # Check if Ultralytics HUB model from https://hub.ultralytics_1.com
    ...
    def __call__(
        ...
        **kwargs,
        ...
        Returns:
            (List[ultralytics_1.engine.results.Results]): A list of prediction results, each encapsulated in a
                Results object.
    ...
    def is_hub_model(model: str) -> bool:
        ...
        Examples:
            >>> Model.is_hub_model("https://hub.ultralytics_1.com/models/MODEL")
            True
    ...
    def save(self, filename: Union[str, Path] = "saved_model.pt") -> None:
        ...
        updates = {
            ...
            "version": __version__,
            "license": "AGPL-3.0 License (https://ultralytics_1.com/license)",
            "docs": "https://docs.ultralytics_1.com",
        }
    ...
    def embed(
        ...
        **kwargs,
        ...
        Examples:
            >>> model = YOLO("yolo11n.pt")
            >>> image = "https://ultralytics_1.com/images/bus.jpg"
    ...
    def track(
        ...
        **kwargs,
        ...
        Returns:
            (List[ultralytics_1.engine.results.Results]): A list of tracking results, each a Results object.
    ...
    def val(
        ...
        **kwargs,
        ...
        Args:
            validator (ultralytics_1.engine.validator.BaseValidator | None): An instance of a custom validator class for
                validating the model.
            **kwargs (Any): Arbitrary keyword arguments for customizing the validation process.

        Returns:
            (ultralytics_1.utils.metrics.DetMetrics): Validation metrics obtained from the validation process.
    ...
    def benchmark(
        ...
        **kwargs,
        ...
        It uses the 'benchmark' function from the ultralytics_1.utils.benchmarks module. The benchmarking is
    ...
    def tune(
        ...
        **kwargs,
        ...
        When Ray Tune is enabled, it leverages the 'run_ray_tune' function from the ultralytics_1.utils.tuner module.
    ...
    def names(self) -> Dict[int, str]:
        ...
        using the 'check_class_names' function from the ultralytics_1.nn.autobackend module. If the predictor is not
