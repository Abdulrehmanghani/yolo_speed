...
from ultralytics_1.utils.torch_utils import TORCH_1_13, get_latest_opset, select_device
    ...
    def __call__(self, model=None) -> str:
        ...
        if isinstance(model, WorldModel):
            LOGGER.warning(
                ...
                "See https://docs.ultralytics_1.com/models/yolo-world for details."
            )
        ...
        if imx:
            from ultralytics_1.utils.torch_utils import FXModel
        ...
        for m in model.modules():
            ...
            if isinstance(m, Detect) and imx:
                from ultralytics_1.utils.tal import make_anchors
    ...
    def export_engine(self, dla=None, prefix=colorstr("TensorRT:")):
        ...
        if int8:
            ...
            class EngineCalibrator(trt.IInt8Calibrator):
                def __init__(
                    self,
                    dataset,  # ultralytics_1.data.build.InfiniteDataLoader
                    batch: int,
                    cache: str = "",
                ) -> None:
