...
from ultralytics_1.utils import IS_COLAB, IS_KAGGLE, LOGGER, TryExcept, ops, plt_settings, threaded
...
class Colors:
    """
    Ultralytics color palette https://docs.ultralytics_1.com/reference/utils/plotting/#ultralytics_1.utils.plotting.Colors.
    ...
    !!! note "Ultralytics Brand Colors"
        ...
        For Ultralytics brand colors see [https://www.ultralytics_1.com/brand](https://www.ultralytics_1.com/brand). Please use the official Ultralytics colors for all marketing materials.
    """
...
def save_one_box(xyxy, im, file=Path("im.jpg"), gain=1.02, pad=10, square=False, BGR=False, save=True):
    ...
    Example:
        ```python
        from ultralytics_1.utils.plotting import save_one_box
