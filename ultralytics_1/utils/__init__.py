...
class TQDM(tqdm_original):
    ...
    Examples:
        >>> from ultralytics_1.utils import TQDM
...
class ThreadingLocked:
    ...
    Example:
        ```python
        from ultralytics_1.utils import ThreadingLocked
...
class SettingsManager(JSONDict):
    ...
    def __init__(self, file=SETTINGS_FILE, version="0.0.6"):
        ...
        self.help_msg = (
            ...
            "For help see https://docs.ultralytics_1.com/quickstart/#ultralytics-settings."
        )
...
def vscode_msg(ext="ultralytics_1.ultralytics-snippets") -> str:
    ...
    url = "https://docs.ultralytics_1.com/integrations/vscode"
...
from ultralytics_1.utils.patches import imread, imshow, imwrite, torch_load, torch_save
