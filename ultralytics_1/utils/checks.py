...
def parse_requirements(file_path=ROOT.parent / "requirements.txt", package=""):
    ...
    Example:
        ```python
        from ultralytics_1.utils.checks import parse_requirements
...
def collect_system_info():
    ...
    from ultralytics_1.utils import ENVIRONMENT  # scope to avoid circular import
    from ultralytics_1.utils.torch_utils import get_cpu_info, get_gpu_info
...
def check_amp(model):
    ...
    Example:
        ...
        from ultralytics_1.utils.checks import check_amp
    ...
    """
    from ultralytics_1.utils.torch_utils import autocast
