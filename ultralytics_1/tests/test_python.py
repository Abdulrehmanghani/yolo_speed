...
from ultralytics_1.cfg import MODELS, TASK2DATA, TASKS
from ultralytics_1.data.build import load_inference_source
...
from ultralytics_1.utils.torch_utils import TORCH_1_9
...
def test_data_utils():
    ...
    from ultralytics_1.data.utils import HUBDatasetStats, autosplit
    from ultralytics_1.utils.downloads import zip_directory

    # from ultralytics_1.utils.files import WorkingDirectory
...
def test_data_converter():
    ...
    from ultralytics_1.data.converter import coco80_to_coco91_class, convert_coco
...
def test_events():
    ...
    from ultralytics_1.hub.utils import Events
...
def test_cfg_init():
    """Test configuration initialization utilities from the 'ultralytics_1.cfg' module."""
    from ultralytics_1.cfg import check_dict_alignment, copy_default_cfg, smart_value
...
def test_utils_init():
    ...
    from ultralytics_1.utils import get_git_branch, get_git_origin_url, get_ubuntu_version, is_github_action_running
...
def test_utils_benchmarks():
    """Benchmark model performance using 'ProfileModels' from 'ultralytics_1.utils.benchmarks'."""
...
def test_utils_torchutils():
    ...
    from ultralytics_1.nn.modules.conv import Conv
    from ultralytics_1.utils.torch_utils import get_flops_with_torch_profiler, profile, time_sync
...
def test_utils_downloads():
    """Test file download utilities from ultralytics_1.utils.downloads."""
    from ultralytics_1.utils.downloads import get_google_drive_file_info
...
def test_utils_files():
    ...
    from ultralytics_1.utils.files import file_age, file_date, get_latest_run, spaces_in_path
...
def test_utils_patches_torch_save():
    ...
    from ultralytics_1.utils.patches import torch_save

    mock = MagicMock(side_effect=RuntimeError)

    with patch("ultralytics_1.utils.patches._torch_save", new=mock):
...
def test_nn_modules_conv():
    ...
    from ultralytics_1.nn.modules.conv import CBAM, Conv2, ConvTranspose, DWConvTranspose2d, Focus
...
def test_nn_modules_block():
    ...
    from ultralytics_1.nn.modules.block import C1, C3TR, BottleneckCSP, C3Ghost, C3x
...
def test_hub():
    ...
    from ultralytics_1.hub import export_fmts_hub, logout
    from ultralytics_1.hub.utils import smart_request
...
def test_classify_transforms_train(image, auto_augment, erasing, force_color_jitter):
    ...
    from ultralytics_1.data.augment import classify_augmentations
...
def test_yolo_world():
    ...
    from ultralytics_1.models.yolo.world.train_world import WorldTrainerFromScratch
