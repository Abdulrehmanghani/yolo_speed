...
from ultralytics_1.cfg import TASK2DATA, TASK2MODEL, TASKS
from ultralytics_1.utils import ASSETS, WEIGHTS_DIR, checks
...
def test_fastsam(task="segment", model=WEIGHTS_DIR / "FastSAM-s.pt", data="coco8-seg.yaml"):
    """Test FastSAM model for segmenting objects in images using various prompts within ultralytics_1."""
    ...
    from ultralytics_1.models.sam import Predictor
...
def test_mobilesam():
    """Test MobileSAM segmentation with point prompts using ultralytics_1."""
